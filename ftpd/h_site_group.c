 ...
 * All rights reserved.
 *
 * $Id: h_site_group.c,v 1.11 2015/03/14 06:11:26 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: h_site_group.c,v 1.11 2015/03/14 06:11:26 marc Exp marc $";
