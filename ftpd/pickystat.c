 ...
 * All rights reserved.
 *
 * $Id: pickystat.c,v 1.11 2015/03/14 06:11:27 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: pickystat.c,v 1.11 2015/03/14 06:11:27 marc Exp marc $";
