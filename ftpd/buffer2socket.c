 ...
 * All rights reserved.
 *
 * $Id: buffer2socket.c,v 1.15 2015/03/14 06:11:24 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: buffer2socket.c,v 1.15 2015/03/14 06:11:24 marc Exp marc $";
