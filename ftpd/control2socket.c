 ...
 *
 * $Id: control2socket.c,v 1.11 2015/03/14 06:11:24 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: control2socket.c,v 1.11 2015/03/14 06:11:24 marc Exp marc $";
