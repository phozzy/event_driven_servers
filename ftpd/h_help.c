 ...
 * All rights reserved.
 *
 * $Id: h_help.c,v 1.14 2015/03/14 06:11:25 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: h_help.c,v 1.14 2015/03/14 06:11:25 marc Exp marc $";
...
void h_help(struct context *ctx, char *arg)
{
	...
	reply(ctx, "  (C)1996-2011 by Marc Huber <Marc.Huber@web.de>\r\n");
	reply(ctx, "\r\n");
