 ...
 * All rights reserved.
 *
 * $Id: ident_connect_out.c,v 1.15 2015/03/14 06:11:26 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: ident_connect_out.c,v 1.15 2015/03/14 06:11:26 marc Exp marc $";
