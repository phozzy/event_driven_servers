 ...
 * All rights reserved.
 *
 * $Id: socket2buffer.c,v 1.14 2015/03/14 06:11:27 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: socket2buffer.c,v 1.14 2015/03/14 06:11:27 marc Exp marc $";
