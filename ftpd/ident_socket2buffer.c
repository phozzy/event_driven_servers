 ...
 * All rights reserved.
 *
 * $Id: ident_socket2buffer.c,v 1.12 2015/03/14 06:11:26 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: ident_socket2buffer.c,v 1.12 2015/03/14 06:11:26 marc Exp marc $";
