 ...
 * All rights reserved.
 *
 * $Id: accept_data.c,v 1.19 2015/03/14 06:11:24 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: accept_data.c,v 1.19 2015/03/14 06:11:24 marc Exp marc $";
