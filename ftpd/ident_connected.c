 ...
 * All rights reserved.
 *
 * $Id: ident_connected.c,v 1.10 2015/03/14 06:11:26 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: ident_connected.c,v 1.10 2015/03/14 06:11:26 marc Exp marc $";
