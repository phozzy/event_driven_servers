 ...
 * All rights reserved.
 *
 * $Id: radix.c,v 1.51 2015/03/14 06:11:30 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: radix.c,v 1.51 2015/03/14 06:11:30 marc Exp marc $";
...
int radix_add(struct radixtree *rt, struct in6_addr *a, int m, void *d)
{
