 ...
 * All rights reserved.
 *
 * $Id: pid_write.c,v 1.15 2015/03/14 06:11:30 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: pid_write.c,v 1.15 2015/03/14 06:11:30 marc Exp marc $";
