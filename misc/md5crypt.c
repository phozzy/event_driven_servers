/*	$Id: md5crypt.c,v 1.3 2015/03/14 06:11:29 marc Exp marc $	*/
...
static const char rcsid[] __attribute__ ((used)) = "$Id: md5crypt.c,v 1.3 2015/03/14 06:11:29 marc Exp marc $";
...
char *md5crypt(const char *pw, const char *salt)
{
    ...
    MD5Update(&ctx, (void *) pw, pw_len);

    /* Then our magic string */
    MD5Update(&ctx, magic, strlen((const char *) magic));

    /* Then the raw salt */
    MD5Update(&ctx, (void *) sp, sl);

    /* Then just as many characters of the MD5(pw,salt,pw) */
    MD5Init(&ctx1);
    MD5Update(&ctx1, (void *) pw, pw_len);
    MD5Update(&ctx1, (void *) sp, sl);
    MD5Update(&ctx1, (void *) pw, pw_len);
    MD5Final(final, &ctx1);
