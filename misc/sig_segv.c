 ...
 *
 * $Id: sig_segv.c,v 1.52 2015/03/14 06:11:30 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: sig_segv.c,v 1.52 2015/03/14 06:11:30 marc Exp marc $";
