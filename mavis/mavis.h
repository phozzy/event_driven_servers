...
#define AV_A_DIGEST_MD5_USER	1
    AV_CHAR("DIGEST_MD5_USER",)
#define AV_A_UDATA		2
    AV_CHAR("UDATA",)
#define AV_A_TIMESTAMP		3
#define AV_A_DIGEST_MD5_NONCE	AV_A_TIMESTAMP
    AV_CHAR("TIMESTAMP",)
#define AV_A_USER		4
    AV_CHAR("USER",)
...
void parse_timespec(struct sym *);
struct mavis_timespec *find_timespec(char *);
