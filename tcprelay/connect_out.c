 ...
 * All rights reserved.
 *
 * $Id: connect_out.c,v 1.17 2015/03/14 06:11:31 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: connect_out.c,v 1.17 2015/03/14 06:11:31 marc Exp marc $";
