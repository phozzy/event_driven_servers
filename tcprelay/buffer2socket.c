 ...
 * All rights reserved.
 *
 * $Id: buffer2socket.c,v 1.13 2015/03/14 06:11:31 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: buffer2socket.c,v 1.13 2015/03/14 06:11:31 marc Exp marc $";
