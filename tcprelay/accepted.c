 ...
 * All rights reserved.
 *
 * $Id: accepted.c,v 1.23 2015/03/14 06:11:31 marc Exp marc $
 *
 */

#include "headers.h"

static const char rcsid[] __attribute__ ((used)) = "$Id: accepted.c,v 1.23 2015/03/14 06:11:31 marc Exp marc $";
